    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div class="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-6 lg:gap-8">
        <div class="col-span-full lg:col-span-2">
          ...
          {/* <p class="mb-6 text-gray-500 sm:pr-8">Filler teery similar to real text</p> */}
...
{/*  */}
      ...
      <div class="border-t py-8 text-center text-sm text-gray-400">© 2023 - Present kurtiishop. All rights reserved.</div>
    </div>
  </div>
</footer>
